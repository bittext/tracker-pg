...
@RestController
@RequestMapping("/api/management/notes")
@RequiredArgsConstructor
public class ManagementMonthNoteController {
    ...
    @GetMapping("/{id}")
    public ManagementMonthNoteDto get(@PathVariable long id) {
    ...
    @PutMapping("/{id}")
    public ManagementMonthNoteDto update(@PathVariable long id, @Valid @RequestBody ManagementMonthNoteWriteRequest body) {
