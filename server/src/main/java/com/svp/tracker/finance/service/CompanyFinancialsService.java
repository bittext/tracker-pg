...
public class CompanyFinancialsService {
    ...
    static MergeEps applyRobinhoodPrimary(
        ...
        if (rh.isEmpty()) {
            ...
            return new MergeEps(onlyAv, false, !onlyAv.isEmpty());
        }
        ...
        for (EarningsRow row : rh) {
            ...
            String fiscal = avq != null && avq.fiscalDateEnding() != null && !avq.fiscalDateEnding().isBlank()
            ...
            out.add(new CompanyFinancialsQuarterDto(
                    fiscal,
                    finite(avq != null ? avq.revenue() : null),
                    finite(avq != null ? avq.netIncome() : null),
                    finite(avq != null ? avq.grossProfit() : null),
                    finite(avq != null ? avq.operatingIncome() : null),
                    finite(avq != null ? avq.netMarginPct() : null),
                    finite(actual),
                    finite(estimate),
                    surprise));
        }
        ...
        return new MergeEps(cleaned, true, usedAlpha);
    }
