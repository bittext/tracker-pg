...
See also: [docs/robinhood-agentic/PHASE0.md](../docs/robinhood-agentic/PHASE0.md) · [PHASE1.md](../docs/robinhood-agentic/PHASE1.md) (read-only sync) · [PHASE2.md](../docs/robinhood-agentic/PHASE2.md) (guarded execution)
